  ...
  head: () => ({
    meta: [
      ...
      { title: "Classe Viva — Gamificação escolar e presença" },
      {
        name: "description",
        content:
          "Chamada gamificada, quizzes interativos e extrato de pontos para professores e alunos.",
      },
      { property: "og:title", content: "Classe Viva — Gamificação escolar e presença" },
      {
        property: "og:description",
        content: "Chamada em um clique, quizzes com prazo e níveis para cada aluno da turma.",
      },
